...
export class init1689720464792 implements MigrationInterface {
    name = 'init1689720464792'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."task_status_enum" AS ENUM('IN_PROGRESS', 'CREATED', 'FINISH')`);
